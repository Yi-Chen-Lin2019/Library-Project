...
namespace UnitTests.DAL
{
    public class DAL_BorrowOrder_Tests
    {
        ...
        [Fact]
        public void BorrowOrderCRUDAsync()
        {
            ...
            //Create
            var result = rep.AddAsync(order).Result;
            ...
            //Delete
            var result3 = rep.DeleteAsync(result).Result;

            Assert.True(result > 0);
            Assert.Equal(order.ReturnDate.Date, result2.ReturnDate.Date);
